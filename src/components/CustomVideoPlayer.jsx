            ...
            <div style={{ position: "relative", width: "100%", maxWidth: "80rem", margin: "auto", backgroundColor: theme.palette.background.default, minHeight: "100vh" }}>
                ...
                <div style={{ position: "absolute", bottom: "5rem", width: "100%", display: "flex", flexWrap: "wrap", justifyContent: "center", alignItems: "center", padding: "1rem", backgroundColor: theme.palette.background.paper, borderRadius: "12px" }}>
                    <Slider
                        ...
                        style={{ flexGrow: 1, marginLeft: 10, width: "100%", color: theme.palette.accent }}
                    />
                    ...
                    <IconButton onClick={togglePlayPause} sx={{ backgroundColor: theme.palette.accent, borderRadius: "14px", padding: "0.8rem", marginInline: "1rem" }}>

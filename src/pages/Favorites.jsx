    ...
    <PageWrapper>
      <Box p={2} pb={8} pt={"3rem"} bgcolor={theme.palette.background.default} minHeight={"100vh"} maxWidth={"60rem"} marginInline={"auto"}>
        <Tabs value={0} textColor="inherit" indicatorColor="none" sx={{ overflowx: "scroll", "& .Mui-selected": { bgcolor: "secondary", color: theme.palette.text.primary } }}>
          <Tab sx={{ bgcolor: theme.palette.background.paper, borderRadius: "8px", padding: "5px 10px", minHeight: "auto", height: "40px", marginRight: "10px", "&.Mui-selected": { bgcolor: theme.palette.accent, color: theme.palette.text.primary } }} label="All" />
          <Tab sx={{ bgcolor: theme.palette.background.paper, borderRadius: "8px", padding: "5px 10px", minHeight: "auto", height: "40px", marginRight: "10px", "&.Mui-selected": { bgcolor: theme.palette.accent, color: theme.palette.text.primary } }} label="Workouts" />
          <Tab sx={{ bgcolor: theme.palette.background.paper, borderRadius: "8px", padding: "5px 10px", minHeight: "auto", height: "40px", marginRight: "10px", "&.Mui-selected": { bgcolor: theme.palette.accent, color: theme.palette.text.primary } }} label="Shorts" />
        </Tabs>
        <Card sx={{ borderRadius: "15px", padding: "10px", backgroundColor: theme.palette.background.paper }}>
          <Box display={"flex"} gap={1.5} alignItems={"center"} mb={1}>
            ...
            <IconButton sx={{ backgroundColor: theme.palette.background.paper, padding: "12px", border: `2px solid ${theme.palette.accent}`, marginLeft: "auto", color: theme.palette.accent }}>
              <PlayArrowIcon />
            </IconButton>
          </Box>
          <Box display={"flex"} gap={1.5} alignItems={"center"} mb={1}>
